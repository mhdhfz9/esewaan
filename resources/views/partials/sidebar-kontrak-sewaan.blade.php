...
@endphp
<details class="group/kontrak-sewaan-mgmt [&::-webkit-details-marker]:hidden" data-sidebar-menu="kontrak" {{ $kontrakSewaanMenuActive ? 'open' : '' }}>
    <summary class="sidebar-nav-summary {{ $kontrakSewaanMenuActive ? 'is-active' : '' }} [&::-webkit-details-marker]:hidden">
        ...
        @include('partials.sidebar-notification-badge', ['count' => $kontrakSewaanCount, 'label' => 'Kontrak baharu dalam senarai', 'badgeKey' => 'kontrak_sewaan'])
